...
/*User Inputs*/
#define NOMINAL_INPUT_VOLTAGE 127.2//123.25//124.4//123.15//110       //Nominal Calibrating RMS Voltage on all phases (Vrms)
#define NOMINAL_INPUT_CURRENT 9.96//7.055//10.00//5         //Nominal Calibrating RMS Current on all phases (Irms)
#define MIN_INPUT_VOLTAGE 20.02
#define MIN_INPUT_CURRENT 0.0215//0.0250
...
#define CALIBRATION2_ANGLE_DEGREES 83//0.12 //Calibration Angle in Degrees.Used for offset calibration
...
****************************************************************************************************************/                                  
#define CURRENT_TRANSFER_FUNCTION 0.00357//0.003535//0.00408   //The RMS voltage at the ADC input pins per input RMS current  (V/A).(2500:1-->0.00408 with default burden resistors)
#define VOLTAGE_TRANSFER_FUNCTION  0.000999//0.001248//0.00125 //The RMS voltage at the ADC input pins per input RMS voltage (V/V) 
/****************************************************************************************************************
...
#define CALIBRATION_ACC_TIME 10            //if EGYACCTIME= 0x1F3F, Accumulation time is 1sec. Change this if EGYACCTIME is changed.
...
*****************************************************************************************************************/
#define CAL_IRMS_CC   3.757711//3.795488//3.28849         // (uA/code)
#define CAL_VRMS_CC   13.428442//10.750844//10.73364       // (uV/code)  
#define CAL_POWER_CC  6.772654//5.476715//4.73755         // (mW/code) Applicable for Active, reactive and apparent power
#define CAL_ENERGY_CC 1.926685//1.557821//1.34757         // (uWhr/xTHR_HI code)Applicable for Active, reactive and apparent energy